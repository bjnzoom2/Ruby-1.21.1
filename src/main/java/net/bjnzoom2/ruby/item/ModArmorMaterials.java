    ...
    public static final RegistryEntry<ArmorMaterial> RUBY_ARMOR_MATERIAL = registerArmorMaterial("ruby",
            () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
                ...
                map.put(ArmorItem.Type.BODY, 4);
                    ...
                    List.of(new ArmorMaterial.Layer(Identifier.of(Ruby.MOD_ID, "ruby"))), 0, 0));

    public static RegistryEntry<ArmorMaterial> registerArmorMaterial(String name, Supplier<ArmorMaterial> material) {
        return Registry.registerReference(Registries.ARMOR_MATERIAL, Identifier.of(Ruby.MOD_ID, name), material.get());
    }
}
